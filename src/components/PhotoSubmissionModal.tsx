...
import { Camera, CheckCircle2, Loader2, Send, SwitchCamera, Upload, X } from 'lucide-react';
...
export default function PhotoSubmissionModal({ open, onExited, onRequestClose }: PhotoSubmissionModalProps) {
  ...
  useEffect(() => {
    if (open) setAlreadySent(sessionStorage.getItem(SESSION_KEY) === '1');
  }, [open]);
